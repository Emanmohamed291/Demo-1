...
/* digit2 */ 
    if(Day_index2==index && incdec==increment){
        if((Date_value.Day_index2<3&&Date_value.Month_index1!=2) ||(Date_value.Day_index2<2&&Date_value.Month_index1==2))
        {
        Date_value.Day_index1++;
        }
        else
 ...
 /* digit1 month    1:9 if digit2=0 0:2     if digit2=1 */ 
    if(Month_index1==index && incdec==increment){
        if((Date_value.Month_index1<9&&Date_value.Month_index1==0)
        ||(Date_value.Month_index1<2&&Date_value.Month_index1==1))
        {
        Date_value.Day_index1++;
        }
        else
        ...
        if((Date_value.Month_index2==1&&Date_value.Month_index1>0)
         ||(Date_value.Month_index2==0&&Date_value.Month_index1>1))
        {
            Date_value.Day_index1--;
        }
        else
